...
const dededo = L.marker([13.5453, 144.8511],{icon: myIcon}).bindPopup('Dededo')
const mangilao = L.marker([13.4702, 144.8456],{icon: myIcon}).bindPopup('Mangilao')
const tamuning = L.marker([13.5005, 144.7956],{icon: myIcon}).bindPopup('Tamuning')
const barrigada = L.marker([13.4708, 144.8181],{icon: myIcon}).bindPopup('Barrigada')
const agana = L.marker([13.4763, 144.7502],{icon: myIcon}).bindPopup('Agana')
const asan = L.marker([13.4608, 144.7247],{icon: myIcon}).bindPopup('Asan')
const piti = L.marker([13.4456, 144.6918],{icon: myIcon}).bindPopup('Piti')
const yona = L.marker([13.4010, 144.7522],{icon: myIcon}).bindPopup('Yona')
const santaRita = L.marker([13.3743, 144.7083],{icon: myIcon}).bindPopup('Santa Rita')
const agat = L.marker([13.3673, 144.6643],{icon: myIcon}).bindPopup('Agat')
const talofofo = L.marker([13.3383, 144.7302],{icon: myIcon}).bindPopup('Talofofo')
const inarajan = L.marker([13.2792, 144.7302],{icon: myIcon}).bindPopup('Inajaran')
const umatac = L.marker([13.3139, 144.6698],{icon: myIcon}).bindPopup('Umatac')
const merizo = L.marker([13.2682, 144.6918],{icon: myIcon}).bindPopup('Merizo')
